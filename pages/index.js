    ...
    }
    {
      ...
      <div className = {`flex flex-col w-screen h-screen mx-0 relative`}>
        <div className = "flex flex-row h-20 bg-gradient-to-r from-gray-100 to-gray-200 ">
          {
          loading && 
          <svg class="right-0 absolute mr-2 mt-2 w-10 h-10 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {login ? 
            <button onClick = {() => changeNewClientMenu()} className = {`bg-gray-300 hover:bg-gray-400 basis-4/5 h-9/12 m-3 rounded-full`} >
               Adicionar Cliente
            </button>
            :
