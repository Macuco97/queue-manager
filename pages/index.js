      ...
      <div className = {`flex flex-col w-screen h-screen mx-0`}>
        ...
        <div className = "flex flex-row h-20 bg-gradient-to-r from-gray-100 to-gray-200 ">
          ...
          {login ? 
            ...
            :
            <button  className = {`basis-1/4 h-9/12 m-3 invisible`} >
            </button>
          }
          <button onClick = {() => changeLoginMenu()} className = "bg-gray-300 hover:bg-gray-400 basis-1/4 h-9/12 m-3 rounded-full">
              Login
          </button>
        </div>
